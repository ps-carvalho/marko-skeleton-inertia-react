    ...
    <div className="min-h-screen bg-gray-50">
      <aside className="fixed inset-y-0 left-0 z-50 w-64 border-r border-gray-200 bg-white">
        ...
        <nav className="space-y-1 p-4">
          <Link href="/dashboard" className={itemClass('Dashboard')}>Dashboard</Link>
          <Link href="/profile" className={itemClass('Profile')}>Profile</Link>
        </nav>
      ...
      <div className="pl-64">
        <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-8">
          <h1 className="text-xl font-semibold text-gray-900">{page.component}</h1>
