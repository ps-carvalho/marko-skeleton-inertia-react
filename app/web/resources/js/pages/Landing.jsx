        ...
        <nav className="border-b border-zinc-200 bg-white">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
            <Link href="/" className="flex items-center gap-3">
              <span className="flex h-9 w-9 items-center justify-center rounded bg-zinc-950 text-sm font-bold text-white">
                M
              </span>
            ...
            <Link
              href="/dashboard"
              className="inline-flex h-10 items-center justify-center rounded bg-zinc-950 px-4 text-sm font-semibold text-white"
            >
              Dashboard
            </Link>
          </div>
        ...
        <section className="mx-auto grid min-h-[720px] max-w-6xl gap-12 px-5 py-16 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-700">
              Keep routes, middleware, auth, and data loading in PHP while
              Inertia renders React screens with Vite and Tailwind.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/dashboard"
                className="inline-flex h-12 items-center justify-center rounded bg-blue-700 px-5 text-sm font-semibold text-white"
              >
                Open dashboard
              </Link>
              <Link
                href="/login"
                className="inline-flex h-12 items-center justify-center rounded border border-zinc-300 bg-white px-5 text-sm font-semibold text-zinc-950"
              >
                Sign in
              </Link>
            </div>
